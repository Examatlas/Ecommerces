...
//         // Log to check if userId is available
...
//         const response = await api.get(`/payment/getOrdersByUserId/${userId}`);
...
//         if (response.data.success) {
//           setOrders(response.data.orders);
//           console.log("Orders fetched:", response.data.orders); // Log the fetched orders
//         } else {
//           throw new Error("Failed to fetch orders.");
//         }
//       } catch (err) {
...
//         <div className="space-y-4">
//           {orders.map((order) => {
//             // Log each order object for debugging
      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-4">
          {orders.map((order) => {
            ...
            // Check if billingDetail exists before accessing its properties
            const billingDetail = order.billingDetail || {};
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start mb-4">
                  ...
                  <div className="p-4 rounded-md shadow-md w-full md:w-1/3 text-sm text-left">
                    ...
                    <p>
                      <strong>Address:</strong> {billingDetail.streetAddress},
                      {billingDetail.city}
                    </p>
                    <p>
                      <strong>State:</strong> {billingDetail.state}{" "}
                      {billingDetail.country}
                    </p>
                    <p>
                      <strong>Pin Code:</strong> {billingDetail.pinCode}
                    </p>
                    <p>
                      <strong>Phone:</strong> {billingDetail.phone}
                    </p>
                    <p>
                      <strong>Email:</strong> {billingDetail.email}
                    </p>
                  </div>
                </div>
