      ...
      <DashboardLayoutBasic>
        <div className="w-full">
          ...
          <div className="flex justify-between mx-4  md:mx-12 my-4 mb-10">
            <div>
              <h1 className="text-2xl md:text-4xl  ml-9 text-left">Exam</h1>
              <p className="text-base md:text-lg  ml-9 text-left">Welcome to Exam Dashboard</p>
            </div>

            <div className="flex items-center gap-2">
          
              <Link to={'/ECommerce/addExam'}>
        ...
        <div className="w-[90%] mx-auto my-4">
          <ExamList searchTerm={searchTerm} />  
        </div>
        </DashboardLayoutBasic>
    </>
